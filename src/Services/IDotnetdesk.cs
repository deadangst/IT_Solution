...
namespace src.Services
{
    public interface IDotnetdesk
    {
        ...
        Task SendEmailByGmailAsync(string fromEmail, string fromFullName, string subject, string message, string email, string smtpUserName, string smtpPassword, string smtpHost, int smtpPort, bool smtpSSL);
    }
}
