...
function Delete(id) {
    swal({
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data.success) {
                    ShowMessage(data.message); // Asegúrate de que este mensaje también esté traducido al español.
                    dataTable.ajax.reload();
                } else {
                    ShowMessageError(data.message); // Asegúrate de que este mensaje también esté traducido al español.
                }
            }
        });
    });
